<?php
   ...
   if(isset($_POST['btncadastrar'])){
    ...
    //  $data= '2005-12-26';
      ...
      $sql = $conecta->prepare("INSERT into tab_clientes (cli_nome, cli_sobrenome, cli_fone, cli_data_nasc) VALUES (:nome,:sobrenome,:fone,:dt_nasc)");
      $sql->bindValue(':nome',$nome);
      $sql->bindValue(':sobrenome',$sobrenome);
      $sql->bindValue(':fone', $fone);
      $sql->bindValue(':dt_nasc', $data);
      $sql->execute();
